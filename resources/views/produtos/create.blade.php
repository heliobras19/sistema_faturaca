                    ...
                    <form action="{{ route('produtos.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <textarea name="descricao" id="descricao" class="mt-1 block w-full">{{ old('descricao') }}</textarea>
                            </div>
                            <div>
                                <label for="preco" class="block text-sm font-medium text-gray-700">Preço</label>
                                <input type="text" name="preco" id="preco" class="mt-1 block w-full" value="{{ old('preco') }}">
                            </div>
                            <div>
